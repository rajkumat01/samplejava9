    //def appName='E2E_App'
    def appName='PerfApps10'
    def snapName=''
    //def deployName = 'TEST'
    //def deployName ='PerfApps10_dep__1'	
    def deployName ='PerfApps10_dep__0'
...
//    def namePath ='component1'
    def namePath ="PerfApps10_dep__coll__comp_0/${JOB_NAME}/${currentBuild.number}"
pipeline {
    agent any
    stages {
