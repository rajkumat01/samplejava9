    //def appName='E2E_App'
    def appName='PerformanceApps0'
    def snapName=''
    //def deployName = 'TEST'
    //def deployName ='PerfApp95_dep__1'	
    def deployName ='PerformanceApps0_dep__0'
...
//    def namePath ='component1'
    def namePath ="PerformanceApps0_dep__coll__comp_0/${JOB_NAME}/${currentBuild.number}"
pipeline {
    agent any
    stages {
